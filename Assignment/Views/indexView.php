          ...
          <div class="col-12">
            <div class="slider-content">
              ...
              <h2 class="title animated">
                <span class="animated d-block" data-animation-in="fadeInLeft" data-delay-in=".800">Uncarbonated and unbothered. </span>
                <span class="animated font-weight-bold" data-animation-in="fadeInRight" data-delay-in="1.5">Join the flavor fiesta.</span>
              </h2>
              <a href="https://www.coca-cola.com/us/en/brands/fresca-sparkling-soda" class="btn btn-outline-primary btn--lg animated mt-45 mt-sm-25" data-animation-in="fadeInLeft" data-delay-in="1.9">More Page</a>
            </div>
          </div>
        </div>
      </div>
