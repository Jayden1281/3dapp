...
<html lang="zxx">
  ...
  <body>
              ...
              <div class="col-12">
                <div class="slider-content">
                  ...
                  <h2 class="title animated">
                    <span class="animated d-block" data-animation-in="fadeInLeft" data-delay-in=".800">Uncarbonated and
                      unbothered. </span>
                    <span class="animated font-weight-bold" data-animation-in="fadeInRight" data-delay-in="1.5">Join the
                      flavor fiesta.</span>
                  </h2>
                  <a href="https://www.coca-cola.com/us/en/brands/fresca-sparkling-soda"
                    class="btn btn-outline-primary btn--lg animated mt-45 mt-sm-25" data-animation-in="fadeInLeft"
                    data-delay-in="1.9">More Page</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row align-items-center slider-height">
              <div class="col-12">
                <div class="slider-content">
                  ...
                  <h2 class="title">
                    <span class="animated d-block" data-animation-in="fadeInRight" data-delay-in=".800">Taste It!
                    </span>
                    <span class="animated font-weight-bold" data-animation-in="fadeInUp" data-delay-in="1.5">Explore
                      Inside</span>
                  </h2>
                  <a href="https://www.coca-cola.com/gb/en/brands/coca-cola-zero-sugar"
                    class="btn btn-outline-primary btn--lg animated mt-45 mt-sm-25" data-animation-in="fadeInLeft"
                    data-delay-in="1.9">More Page</a>
                </div>
              </div>
            ...
            <div class="row align-items-center slider-height">
              <div class="col-12">
                <div class="slider-content">
                  ...
                  <h2 class="title">
                    <span class="animated d-block" data-animation-in="fadeInRight" data-delay-in=".800">Beverage
                      Lab</span>
                    <span class="animated font-weight-bold" data-animation-in="fadeInUp" data-delay-in="1.5">Coca‑Cola
                      Store</span>
                  </h2>
                  <a href="https://www.coca-cola.com/gb/en/brands/glaceau-smartwater"
                    class="btn btn-outline-primary btn--lg animated mt-45 mt-sm-25" data-animation-in="fadeInLeft"
                    data-delay-in="1.9">More Page</a>
                </div>
              </div>
          ...
          <div class="row align-items-center">
            <div class="col-12">
              <div class="section-title text-center">
                ...
                <p class="text">
                  Treat your tastebuds to a trip around the world with a sampling of different beverages.
                </p>
                      ...
                      <div class="card-body p-0">
                        <div class="media flex-column">
                          <div class="product-thumbnail position-relative">
                            ...
                            <a href="https://www.coca-cola.com/us/en/brands/fresca-sparkling-soda">
                              <img class="first-img" style="width: 300px; height: 300px;"
                                src="Controls/static/picture/bimg.png">
                            </a>
                          ...
                          <div class="media-body">
                            <div class="product-desc">
                              ...
                              <p>Barq’s has bite! Do you know why? Well, it’s unique Barq’s spice is what makes
                                this root beer soda truly original and truly tasty, complete with a caffeine kick. Not
                                to mention the full-bodied flavor that is so distinct and different it can only
                                be Barq’s</p>
                      ...
                      <div class="card-body p-0">
                        <div class="media flex-column">
                          <div class="product-thumbnail position-relative">
                            ...
                            <a href="https://www.coca-cola.com/gb/en/brands/coca-cola-zero-sugar">
                              <img class="first-img" style="width: 300px; height: 300px;"
                                src="Controls/static/picture/dimg.png" alt="<?php echo $product['product_name']; ?>">
                            </a>
                          ...
                          <div class="media-body">
                            <div class="product-desc">
                              ...
                              <p>Topo Chico Sparkling Mineral Water has been bottled at the source in Monterrey, Mexico,
                                since 1985. Its natural mineral composition is great for quenching thirst.</p>
                              <div class="star-rating">
                                <span class="ion-ios-star"></span>
                                <span class="ion-ios-star"></span>
                                <span class="ion-ios-star"></span>
                      ...
                      <div class="card-body p-0">
                        <div class="media flex-column">
                          <div class="product-thumbnail position-relative">
                            ...
                            <a href="https://www.coca-cola.com/gb/en/brands/glaceau-smartwater">
                              <img class="first-img" style="width: 300px; height: 300px;"
                                src="Controls/static/picture/cimg.png" alt="<?php echo $product['product_name']; ?>">
                            </a>
                          ...
                          <div class="media-body">
                            <div class="product-desc">
                              ...
                              <p>It's the grapefruit flavor you know with a crisp peach taste you'll love. It's a flavor
                                experience born of sweet and citrus blends, with no sugar, no caffeine, and no calories.
                              </p>
                              <div class="star-rating">
                                <span class="ion-ios-star"></span>
                                <span class="ion-ios-star"></span>
    ...
    <script src="static/js/jquery-3.6.0.min.js">audioElement.play();</script>
